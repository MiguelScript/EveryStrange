...
<div class="contenido"> 
 ...
 <div class="tabla">
 <form enctype="multipart/form-data" action="procesar_registro.php" method="POST">
...
<table>
  ...
  <td> <p> Apellido </p>  </td> 
  <td> <input type="text" name="apellido" placeholder="Ingresa tu apellido">  </td> 
  ...
  <tr class="celda-oscura"> <td colspan="2"> <input name="uploadedfile" type="file" /> </td>  </tr> 
...
<br>
<p class="linea-extra"> Si ya estas registrado <a href="ingreso.php"> Ingresa </a> </p>
 </div>
